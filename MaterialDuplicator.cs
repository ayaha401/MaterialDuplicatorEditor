...
namespace AyahaGraphicDevelopTools.MaterialDuplicate
{
    /// <summary>
    /// マテリアルにかかわってるテクスチャごと複製するツール
    /// </summary>
    public class MaterialDuplicator : EditorWindow
    {
        ...
        private void DuplicateMaterialAndTexture(Material targetMaterial)
        {
            ...
            string duplicatedMatPath =
                AssetDatabase.GenerateUniqueAssetPath($"{_duplicateMaterialSaveFolder}/{matName}_Copy.mat");
